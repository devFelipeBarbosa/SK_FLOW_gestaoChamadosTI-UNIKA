// Ajuste de Chamado TI na Criação
...
if (linhaExistente) {
    ...
    tabChamado[c].setCampo("IDTAREFA", 'UserTask_1a46dwv');

    tabChamado[c].setCampo("STATUSCHAMADO", 'A'); // Atualiza o status do chamado TI para 'A' - Novo quando desatribuído a tarefa
