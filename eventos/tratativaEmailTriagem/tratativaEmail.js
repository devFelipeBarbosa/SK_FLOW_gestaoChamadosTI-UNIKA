...
var dataPrevista = tabChamado[c].getCampo("PREVATENDIMENTO") || 'Sem data prevista';

var textoEmail = "<b>Titulo: </b>" + titulo + ";<br>" + "<b>Descrição: </b><br>" + descricao;

textoEmail += "<br>-------------- Dados do Chamado ---------------<br>"
    ...
    + "<b>Data Prevista de Entrega: </b>" + dataPrevista + "(OBS.: a previsão de entrega pode sofrer alterações ao longo do atendimento).<br>";
