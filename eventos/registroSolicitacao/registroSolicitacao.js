...
for (var i = 0; i < tabChamado.length; i++) { 
    ...
    if (!linhaExistente) { 
        ...
        try { 
            ...
            console.error("Erro ao salvar os campos alterados: ", e); 
            throw new Error("Erro ao <b>salvar os campos alterados</b>! <br>" + e.message); 
        } 

    } else { 

        tabChamado[i].setCampo("CODUSU", codUsu); 
        tabChamado[i].setCampo("CODUSU", codUsu); 
        tabChamado[i].setCampo("TIPO", tipo); 
        tabChamado[i].setCampo("ID_CATEGORIATI", categoria); 
        tabChamado[i].setCampo("CODLOCAL", codLocal); 
        tabChamado[i].setCampo("TITULO", titulo); 
        tabChamado[i].setCampo("TEXTOCHAMADO", descricao); 
        tabChamado[i].setCampo("STATUSCHAMADO", 'N'); 
        tabChamado[i].setCampo("ORIGEMCHAMADO", 'F'); 
        tabChamado[i].setCampo("URGENCIA", urgencia); 
        ...
        tabChamado[i].setCampo("CICLO1", 'NA'); // regra de negócio inicial: CICLO1 inicial igual a NA 
        tabChamado[i].setCampo("CODUSUALTER", codUsu); 
        tabChamado[i].setCampo("TERCEIRO", 'NA'); // TERCEIRO regra do negócio: igual a NA no inicio 
        tabChamado[i].setCampo("STATUSTERCEIRO", 'NA'); // STATUSTERCEIRO regra do negócio: igual a NA no inicio 
        tabChamado[i].setCampo("CICLO2", 'N'); // CICLO2 regra do negócio: igual a N no inicio 
        tabChamado[i].setCampo("CICLO3", 'NA'); // CICLO3 regra do negócio: igual a NA no inicio CLICO3 
        tabChamado[i].setCampo("AVALIACAO", '0'); // AVALIACAO regra do negócio: igual a 0 (texto) no inicio     
